...
class User extends Component {
    ...
    constructor(props) {
    super(props);
    this.state = {user: '',name:'',email:'',password:'',style:'',item:[]};
  ...
  handleSubmit(event) {
    ...
    const serverport = {
        ...
        axios.post('http://localhost:5000/api/users', serverport)
                        ...
                        <div className="bs-row bs-row-sm15">
                            ...
                            <div className="bs-col sm-50-15">
                                <div className="item">
                                    ...
                                    <input type="text" className="input-modal" name="password" value={this.state.password} onChange={this.handlePassChange}/>
                                </div>
                            </div>
                        </div>
